...
addFields = {
    ...
    8: {'name': 'DamageDesc', 'type': 'TEXT', 'precision': None, 'scale': None, 'length': 500, 'alias': 'Description of Damage', 'domain': None},
    9: {'name': 'COMMENT', 'type': 'TEXT', 'precision': None, 'scale': None, 'length': 500, 'alias': 'Additional Comments', 'domain': None},
    10: {'name': 'BIZ_NAME', 'type': 'TEXT', 'precision': None, 'scale': None, 'length': 150, 'alias': 'Parcel Name', 'domain': None},
    11: {'name': 'OWNER_NAME_1', 'type': 'TEXT', 'precision': None, 'scale': None, 'length': 150, 'alias': 'Parcel Owner 1', 'domain': None},
    12: {'name': 'OWNER_NAME_2', 'type': 'TEXT', 'precision': None, 'scale': None, 'length': 150, 'alias': 'Parcel Owner 2', 'domain': None},
    13: {'name': 'OWNER_CONTACT', 'type': 'TEXT', 'precision': None, 'scale': None, 'length': 150, 'alias': 'Owner Contact 1', 'domain': None},
    14: {'name': 'OWNER_ADDRESS', 'type': 'TEXT', 'precision': None, 'scale': None, 'length': 200, 'alias': 'Owner Contact 2', 'domain': None},
    15: {'name': 'OWNER_SUITE', 'type': 'TEXT', 'precision': None, 'scale': None, 'length': 50, 'alias': 'Owner Suite', 'domain': None},
    16: {'name': 'OWNER_CITY', 'type': 'TEXT', 'precision': None, 'scale': None, 'length': 50, 'alias': 'Owner City', 'domain': None},
    17: {'name': 'OWNER_STATE', 'type': 'TEXT', 'precision': None, 'scale': None, 'length': 50, 'alias': 'Owner State', 'domain': None},
    18: {'name': 'OWNER_COUNTRY', 'type': 'TEXT', 'precision': None, 'scale': None, 'length': 50, 'alias': 'Owner Country', 'domain': None},
    19: {'name': 'OWNER_ZIPCODE', 'type': 'TEXT', 'precision': None, 'scale': None, 'length': 9, 'alias': 'Owner Zip', 'domain': None},
    20: {'name': 'STREET_NUM', 'type': 'LONG', 'precision': 10, 'scale': None, 'length': None, 'alias': 'Parcel St Number', 'domain': None},
    21: {'name': 'STREET_HALF_NUM', 'type': 'TEXT', 'precision': None, 'scale': None, 'length': 5, 'alias': 'Parcel St Number Half', 'domain': None},
    22: {'name': 'FULL_STREET_NAME', 'type': 'TEXT', 'precision': None, 'scale': None, 'length': 60, 'alias': 'Parcel Full Street Name', 'domain': None},
    23: {'name': 'BLDG_ID', 'type': 'TEXT', 'precision': None, 'scale': None, 'length': 5, 'alias': 'Parcel Building', 'domain': None},
    24: {'name': 'UNIT_ID', 'type': 'TEXT', 'precision': None, 'scale': None, 'length': 5, 'alias': 'Parcel Unit', 'domain': None},
    27: {'name': 'IMPR_VAL', 'type': 'DOUBLE', 'precision': 38, 'scale': 8, 'length': None, 'alias': 'Improvement Value', 'domain': None},
    28: {'name': 'LAND_VAL', 'type': 'DOUBLE', 'precision': 38, 'scale': 8, 'length': None, 'alias': 'Land Value', 'domain': None},
    29: {'name': 'LAND_AG_EXEMPT', 'type': 'LONG', 'precision': 10, 'scale': None, 'length': None, 'alias': 'Ag Exempt', 'domain': None},
    30: {'name': 'AG_USE_VAL', 'type': 'LONG', 'precision': 10, 'scale': None, 'length': None, 'alias': 'Ag Use Value', 'domain': None},
    31: {'name': 'TOT_VAL', 'type': 'DOUBLE', 'precision': 38, 'scale': 8, 'length': None, 'alias': 'Market Value', 'domain': None},
    32: {'name': 'SPTD_CODE', 'type': 'TEXT', 'precision': None, 'scale': None, 'length': 50, 'alias': 'SPTD Code', 'domain': None},
    33: {'name': 'DWEB_ACCT', 'type': 'TEXT', 'precision': None, 'scale': None, 'length': 200, 'alias': 'DCAD Account Link', 'domain': None},
    34: {'name': 'DWEB_HIST', 'type': 'TEXT', 'precision': None, 'scale': None, 'length': 200, 'alias': 'DCAD History Link', 'domain': None},
    35: {'name': 'PROP_CLASS', 'type': 'LONG', 'precision': 10, 'scale': None, 'length': None, 'alias': 'Zoning Clas', 'domain': None},
    36: {'name': 'ZONE', 'type': 'TEXT', 'precision': None, 'scale': None, 'length': 10, 'alias': 'Zone', 'domain': None},
    37: {'name': 'FULL_ZONE', 'type': 'TEXT', 'precision': None, 'scale': None, 'length': 50, 'alias': 'Full Zone', 'domain': None},
    38: {'name': 'DAMAGE_CALC', 'type': 'DOUBLE', 'precision': 38, 'scale': 8, 'length': None, 'alias': 'Calculated Damage Value', 'domain': None},
}
